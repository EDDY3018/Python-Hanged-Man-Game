...
# first say hello
def main():
    print("Hello, Welcome to our hanging man game")
    name = f.ask_for_name()
    scores = {}
    ...
    if name in scores.keys():
        print("Welcome back {name} ! It's nice to see you again :)".format(name=name))
        print("By the way, your total score so far is {} : way to go !".format(scores[name]))
    else:
        scores[name] = 0
        print("got it {name}, nice to meet you ! I'm compy. I will save you in my database so that I will remember you next time :) just type your name in next time you start this script.".format(name=name))
